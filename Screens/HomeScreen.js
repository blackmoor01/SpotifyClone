import {View, Text, Image, SafeAreaView, ScrollView, Pressable, FlatList} from 'react-native'
...
const HomeScreen = () => {
  ...
  const Message = greetingMessage();//Returns either 1.Good Morning 2.Good Afternoon 3.Good Evening
       ...
       <View style={{padding:10,flexDirection:"row", alignItems:"center", justifyContent:"space-between"}}>
        ...
        <View style={{flexDirection:"row", alignItems:"center", justifyContent:"space-between"}}>
          ...
          <View style={{
            ...
            <Image style={{width:55,height:55}} source={{uri:"https;//i.pravator.cc/100"}}/>
